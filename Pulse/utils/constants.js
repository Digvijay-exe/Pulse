export const CONSTANTS = {
  ...
  // Existing Pulse-danish-dev velocity-loss warning criterion: a valid
  // concentric phase is more than 1.5x the fastest calibration lift.
  PHONE_PROTOTYPE_SLOW_REP_MULTIPLIER: 1.5,
