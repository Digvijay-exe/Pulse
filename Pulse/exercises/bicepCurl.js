...
export const BicepCurl = {
  ...
  createCalibration(reps, bottomGravity) {
    ...
    return {
      ...
      // Same fastest-lift reference used by Pulse-danish-dev. It is retained
      // for a transparent slow-rep debug guard; the set baseline is still the
      // robust median velocity of all valid calibration reps.
      fastestConcentricDurationMs: Math.min.apply(null, concentricDurations),
